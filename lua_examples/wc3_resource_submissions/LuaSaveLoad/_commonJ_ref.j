...
native BlzFrameGetChildrenCount(framehandle)
native BlzFrameGetChild (framehandle, index)       Returns the non String/Texture childFrame with that index: should be called with 0 to BlzFrameGetChildrenCount(frame) - 1​       
